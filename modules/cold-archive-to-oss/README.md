...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cold_archive_ram_role"></a> [cold\_archive\_ram\_role](#module\_cold\_archive\_ram\_role) | terraform-alicloud-modules/ram-role/alicloud | n/a |
...
|------|-------------|------|---------|:--------:|
| <a name="input_archive_ram_role_name"></a> [archive\_ram\_role\_name](#input\_archive\_ram\_role\_name) | n/a | `string` | `"The name of ram role that sls will archive logs to oss by assuming this role."` | no |
...
| <a name="output_export_job_ids"></a> [export\_job\_ids](#output\_export\_job\_ids) | n/a |
| <a name="output_export_jobs"></a> [export\_jobs](#output\_export\_jobs) | n/a |
<!-- END_TF_DOCS -->